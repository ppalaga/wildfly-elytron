 ...
 */
public final class X500PrincipalUtilMethodHandles {

    private static final String[] NO_STRINGS = new String[0];
    private static final Class<?> X500_NAME_CLASS;
    private static final MethodHandle AS_X500_PRINCIPAL_HANLDE;

    static {
        Class<?> x500Name = null;
        MethodHandle asX500PrincipalHandle = null;
        try {
            x500Name = Class.forName("sun.security.x509.X500Name", true, X500PrincipalUtilMethodHandles.class.getClassLoader());
        ...
        AS_X500_PRINCIPAL_HANLDE = asX500PrincipalHandle;
    }

    private X500PrincipalUtilMethodHandles() {
    }
    ...
    public static X500Principal asX500Principal(Principal principal, boolean convert) {
        ...
        if (X500_NAME_CLASS != null && X500_NAME_CLASS.isAssignableFrom(principal.getClass())) {
            try {
                return (X500Principal) AS_X500_PRINCIPAL_HANLDE.invoke(principal);
