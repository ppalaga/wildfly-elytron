 ...
 */
public final class X500PrincipalUtilReflection {

    private static final String[] NO_STRINGS = new String[0];
    private static final Class<?> X500_NAME_CLASS;
    private static final Method X500_NAME_AS_X500_PRINCIPAL_METHOD;

    static {
        Class<?> x500Name = null;
        Method asX500PrincipalMethod = null;
        try {
            x500Name = Class.forName("sun.security.x509.X500Name", true, X500PrincipalUtilReflection.class.getClassLoader());
            asX500PrincipalMethod = x500Name.getDeclaredMethod("asX500Principal");
        } catch (Throwable t) {}
        X500_NAME_CLASS = x500Name;
        X500_NAME_AS_X500_PRINCIPAL_METHOD = asX500PrincipalMethod;
    }

    private X500PrincipalUtilReflection() {
    }
    ...
    public static X500Principal asX500Principal(Principal principal, boolean convert) {
        ...
        if (X500_NAME_CLASS != null && X500_NAME_CLASS.isAssignableFrom(principal.getClass())) {
            try {
                return (X500Principal) X500_NAME_AS_X500_PRINCIPAL_METHOD.invoke(principal);
